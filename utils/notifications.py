...
async def notify_users_by_phone(staffs:List[Staffs], camera, time_of_detection):
    ...
    phone_security_personnels = [staff.phone_number for staff in staffs if staff.is_security_personnel]
